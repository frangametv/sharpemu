...
public static class FontExports
{
        ...
        out FallbackRectangle updateRectangle)
    {
        ...
        // Use readable bitmap glyphs for the common UI repertoire. The old
        // codepoint-bit rectangle made every character look like a broken box.
    ...
    {
        var glyph = NormalizeFallbackCodepoint(codepoint);
        if (glyph is >= 32 and <= 90)
        {
            var column = FallbackAscii5x7[((int)glyph - 32) * FallbackPatternWidth + x];
            return ((column >> y) & 1) != 0;
        }

        // A visible replacement character for unsupported scripts.
        return x == 0 || x == FallbackPatternWidth - 1 ||
               y == 0 || y == FallbackPatternHeight - 1 ||
               (x == 2 && y is 2 or 4);
    }

    private static uint NormalizeFallbackCodepoint(uint codepoint) => codepoint switch
    {
        >= 'a' and <= 'z' => codepoint - 32,
        0x00C0 or 0x00C1 or 0x00C2 or 0x00C3 or 0x00C4 or 0x00C5 or
        0x00E0 or 0x00E1 or 0x00E2 or 0x00E3 or 0x00E4 or 0x00E5 => 'A',
        0x00C8 or 0x00C9 or 0x00CA or 0x00CB or 0x00E8 or 0x00E9 or 0x00EA or 0x00EB => 'E',
        0x00CC or 0x00CD or 0x00CE or 0x00CF or 0x00EC or 0x00ED or 0x00EE or 0x00EF => 'I',
        0x00D2 or 0x00D3 or 0x00D4 or 0x00D5 or 0x00D6 or 0x00F2 or 0x00F3 or 0x00F4 or 0x00F5 or 0x00F6 => 'O',
        0x00D9 or 0x00DA or 0x00DB or 0x00DC or 0x00F9 or 0x00FA or 0x00FB or 0x00FC => 'U',
        0x00C7 or 0x00E7 => 'C',
        0x00D1 or 0x00F1 => 'N',
        _ => codepoint,
    };

    private static ReadOnlySpan<byte> FallbackAscii5x7 =>
    [
        ...
        0,0x1C,0x22,0x41,0, 0,0x41,0x22,0x1C,0, 8,0x2A,0x1C,0x2A,8, 8,8,0x3E,8,8,
        ...
        0,8,0x14,0x22,0x41, 0x14,0x14,0x14,0x14,0x14, 0x41,0x22,0x14,8,0, 2,1,0x51,9,6,
